            ...
            switch(event.type)
            {
                ...
                case KeyPress:
                    ...
                    switch(keys[0])
                    {
                        ...
                        case '9':
                            glViewport(((GLsizei)winWidth - (GLsizei)winWidth /2 ) /2, 
                                       ((GLsizei)winHeight - (GLsizei)winHeight / 2) / 2, 
                                       (GLsizei)winWidth / 2, (GLsizei)winHeight / 2);
                            break;
...
void CreateWindow(void)
{
    ...
    XStoreName(gpDisplay, gWindow, "OpenGL : MultiViewport");
