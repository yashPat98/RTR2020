...
@implementation OpenGLView
{
    ...
    -(void)reshape
    {
        ...
        {
            projectionMatrix = vmath::ortho( -100.0f,                                               //left
                                              100.0f,                                               //right
                                             -100.0f * (rect.size.height / rect.size.width),        //bottom
                                              100.0f * (rect.size.height / rect.size.width),        //top
                                             -100.0f,                                               //near
                                              100.0f );                                             //far
        }
        else
        {
            projectionMatrix = vmath::ortho( -100.0f * (rect.size.width / rect.size.height),        //left
                                              100.0f * (rect.size.width / rect.size.height),        //right
                                             -100.0f,                                               //bottom
                                              100.0f,                                               //top
                                             -100.0f,                                               //near
                                              100.0f );                                             //far
