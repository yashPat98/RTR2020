...
@implementation AppDelegate
{
    ...
    -(void)applicationDidFinishLaunching:(NSNotification*)aNotification
    {
        ...
        [window setTitle:@"OpenGL : Textured Animation"];
        [window center];
...
@implementation OpenGLView
{
    ...
    -(void)prepareOpenGL
    {
        ...
        if(!stone_texture)
        {
            fprintf(gpFile, "Error : failed to load Stone.bmp texture.\n");
            [self release];
            [NSApp terminate:self];
        }
        ...
        if(!kundali_texture)
        {
            fprintf(gpFile, "Error : failed to load Vijay_Kundali.bmp texture.\n");
            [self release];
            [NSApp terminate:self];
        }
