// ------------------------
// Name :        Yash Patel
// Assignment :  Lights And Materials
// Date :        29-11-2020
// ------------------------
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szAppName,
        TEXT("OpenGL : Lights And Materials"),
...
void Display(void)
{
    ...
    gluSphere(quadric, 0.2f, 30, 30);               //normals are calculated internally
