...
void ToggleFullscreen(void)
{
    ...
    DEVMODE dmScreen = { sizeof(DEVMODE) };                                        
    ...
    {   
        ...
        if(dwStyle & WS_OVERLAPPEDWINDOW)
        {
            if(GetWindowPlacement(ghwnd, &wpPrev))
            {
                ...
                dmScreen.dmPelsWidth = WIDTH;
                dmScreen.dmPelsHeight = HEIGHT;
    ...
    {
        EnumDisplaySettings(NULL, ENUM_REGISTRY_SETTINGS, &dmScreen);
        ChangeDisplaySettings(&dmScreen, 0);
