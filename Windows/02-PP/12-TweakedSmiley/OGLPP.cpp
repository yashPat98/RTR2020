...
GLuint fragmentShaderObject;       //handle to fragment sahder object
...
GLuint vbo_square_texture;         //handle to vertex buffer object for texture of square

GLuint mvpMatrixUniform;
GLuint textureSamplerUniform;
GLuint textureToggleBoolUniform;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    TCHAR szAppName[] = TEXT("OpenGL : Tweaked Smiley");   //name of window class
...
void Initialize(void)
{
    ...
    void UnInitialize(void);                                    //release resources
    bool loadGLTexture(GLuint* texture, TCHAR ResourceID[]);    //load texture from resource file 
    ...
    const GLchar* fragmentShaderSourceCode = 
        ...
        "uniform bool u_textureToggleBool;"                              \
        "void main(void)"                                                \
        "{"                                                              \
        "   if(u_textureToggleBool)"                                     \
        "   {"                                                           \
    ...
    //binding of shader program with vertex shader position attribute
    glBindAttribLocation(shaderProgramObject, AMC_ATTRIBUTE_POSITION, "vPosition");

    //binding of shader program with vertex shader texture attribute
    ...
    //get uniform textureToggle bool location
    textureToggleBoolUniform = glGetUniformLocation(shaderProgramObject, "u_textureToggleBool");
...
void Display(void)
{
    ...
    if(keypress == 0)
    {
        glUniform1i(textureToggleBoolUniform, GL_TRUE);
    }
    else
    {
        glUniform1i(textureToggleBoolUniform, GL_FALSE);
    }
