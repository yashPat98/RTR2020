...
GLuint vbo_pyramid_color;         //handle to vertex buffer object for colors of triangle
...
GLuint vbo_cube_color;           //handle to vertex buffer object for colors of square
