// ------------------------
// Name :        Yash Patel
// Assignment :  Textured Cube And Pyramid 
// Date :        02-11-2020
// ------------------------
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szAppName,
        TEXT("OpenGL : Textured Cube And Pyramid"),
...
void Initialize(void)
{
    ...
    //enable 2D-texture (enables texture memory)
