                      ...
                      implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
    ...
    float square_rotation_angle = 0.0f;
    ...
    private void render()
    {
        ...
        Matrix.setRotateM(rotationMatrix, 0, triangle_rotation_angle, 0.0f, 1.0f, 0.0f);
        ...
        Matrix.translateM(translateMatrix, 0, 1.5f, 0.0f, -6.0f);
        Matrix.setRotateM(rotationMatrix, 0, square_rotation_angle, 0.0f, 1.0f, 0.0f);
        Matrix.multiplyMM(modelViewMatrix, 0, translateMatrix, 0, rotationMatrix, 0);
        Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, modelViewMatrix, 0);
